...
const CACHED_FILES = ["index.html","index.js","index.wasm","index.pck","webp_attack.pck","webp_battlegear.pck","webp_creature.pck","webp_location.pck","webp_mugic.pck","index.offline.html","index.icon.png","index.apple-touch-icon.png"];
